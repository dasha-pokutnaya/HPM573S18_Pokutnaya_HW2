# Problem 1:Implement the HUI3 instrument(Weight 1).
...
# HUI3 attributes, definition of attribute levels, attribute coefficients as well as the formula to calculate health
# scores can be found on the class Canvas under Files/Homework Assignments/HW2.
# More information about HUI3 instrument can be found at http://www.healthutilities.com/hui3.htm(Note
# that we want to implement “HUI3 Multi-Attribute Utility Function” and not “HUI3 Single-Attribute Utility Function”.
